...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/Tests-722%20Passed-brightgreen.svg" alt="Tests" /></a>
...
- **722 Automated Tests Passed** across 20 test suites (0 failed, 1 benchmark skipped).
...
| **Physics Solver** | Fully deterministic rigid-body solver (Sequential Impulses, Warm Starting, Baumgarte position correction, SAT narrowphase, Coulomb friction) + dynamic-body character controller. |
...
| **World & Time** | Day/night cycle driver, procedural heightfield terrain, and UDP transport + reliable channel + snapshots (multiplayer kickoff). |
